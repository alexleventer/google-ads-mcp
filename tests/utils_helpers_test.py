...
class TestResolveEnum(unittest.TestCase):
    ...
    def test_resolve_different_enum_types(self):
        ...
        result = utils.resolve_enum("AdvertisingChannelTypeEnum", "SEARCH")
        self.assertEqual(result, 2)

        result = utils.resolve_enum("AdGroupStatusEnum", "PAUSED")
        self.assertEqual(result, 3)
...
class TestExecuteMutate(unittest.TestCase):
    ...
    def test_execute_mutate_calls_correct_service(self, mock_get_service):
        ...
        self.assertEqual(result, ["customers/123/campaigns/456"])

    @patch("ads_mcp.utils.get_googleads_service")
    def test_execute_mutate_returns_multiple_results(self, mock_get_service):
        ...
        self.assertEqual(result[0], "customers/123/campaigns/1")
        self.assertEqual(result[1], "customers/123/campaigns/2")
