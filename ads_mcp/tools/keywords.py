...
def create_keyword(
    ...
    criterion.status = utils.resolve_enum("AdGroupCriterionStatusEnum", status)
...
write_mcp.add_tool(
    Tool.from_function(create_keyword, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(update_keyword, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(remove_keyword, annotations=WRITE_ANNOTATIONS)
)
