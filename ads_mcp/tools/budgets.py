...
write_mcp.add_tool(
    Tool.from_function(create_campaign_budget, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(update_campaign_budget, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(remove_campaign_budget, annotations=WRITE_ANNOTATIONS)
)
