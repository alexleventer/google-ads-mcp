...
def remove_ad_group(
    ...
    operation = client.get_type("AdGroupOperation")
    ad_group_service = utils.get_googleads_service("AdGroupService")
    operation.remove = ad_group_service.ad_group_path(customer_id, ad_group_id)
...
write_mcp.add_tool(
    Tool.from_function(create_ad_group, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(update_ad_group, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(
    Tool.from_function(remove_ad_group, annotations=WRITE_ANNOTATIONS)
)
