...
write_mcp.add_tool(
    Tool.from_function(
        create_responsive_search_ad, annotations=WRITE_ANNOTATIONS
    )
)
write_mcp.add_tool(
    Tool.from_function(update_ad_group_ad_status, annotations=WRITE_ANNOTATIONS)
)
write_mcp.add_tool(Tool.from_function(remove_ad, annotations=WRITE_ANNOTATIONS))
